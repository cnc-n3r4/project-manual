...
TO DISPLAY OTHER Jl()EXES, AFTER PRESSING
...
Following "PROT', enter the device name, file name to be protected, and option code.
...
Example 1: PROT LJ ABC.MIN or PROT LJ MD1 :ABC.MIN

This instruction protects the file ABC.MIN registered in the memory.

Example 2: PROT LJ BCD.MIN;C or PROT LJ MD1 :BCD.MlN;C

This instruction cancels protection of the file BCD.MIN registered in the memory.

Example 3: PROT LJ CDE.MIN;V or PROT LJ MD1 :CDE.MIN;V
...
Example 4: PROT LJ DEF.MIN;CV or PROT L...I MD1 :DEF.MIN;CV
